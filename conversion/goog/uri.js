 ...
 *
 * Use new Uri(string) to parse a URI string.
 *
 ...
 * -- so<code>new Uri('/foo%20bar').getPath()</code> will return the
 * decoded path, <code>/foo bar</code>.
 *
 * Reserved characters (see RFC 3986 section 2.2) can be present in
 * their percent-encoded form in scheme, domain, and path URI components and
 * will not be auto-decoded. For example:
 * <code>new Uri('rel%61tive/path%2fto/resource').getPath()</code> will
 ...
 * <code>new Uri('/foo').setFragment('part').toString()</code>.
 *
 * @param {*=} uri Optional string URI to parse, or if a Uri is
 ...
 */
Uri.prototype.setScheme = function (newScheme, decode) {
 ...
 * @return {!Uri} Reference to this URI object.
 */
Uri.prototype.setUserInfo = function (newUserInfo, decode) {
  this.userInfo_ = decode ? Uri.decodeOrEmpty_(newUserInfo) :
    newUserInfo;
  return this;
};
 ...
 * @return {!Uri} Reference to this URI object.
 */
Uri.prototype.setDomain = function (newDomain, decode) {
  this.domain_ = decode ? Uri.decodeOrEmpty_(newDomain, true) :
    newDomain;
  return this;
};
 ...
 * @return {!Uri} Reference to this URI object.
 */
Uri.prototype.setPath = function (newPath, decode) {
 ...
 * @return {!Uri} Reference to this URI object.
 */
Uri.prototype.setQueryData = function (queryData, decode) {
 ...
 * @return {!Uri} Reference to this URI object.
 */
Uri.prototype.setFragment = function (newFragment, decode) {
  this.fragment_ = decode ? Uri.decodeOrEmpty_(newFragment) :
    newFragment;
  return this;
};
 ...
 * @private
 */
Uri.decodeOrEmpty_ = function (val, preserveReserved) {
 ...
 *     the object.
 * @param {Uri=} uri Optional uri object that should have its
 *     cache invalidated when this object updates. Deprecated -- this
 *     is no longer required.
 * @constructor
 * @final
 */
Uri.QueryData = function (query, uri) {
  /**
